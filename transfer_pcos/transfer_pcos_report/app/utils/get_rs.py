...
def test_format():             
    infile1 = 'guoke_genotype.txt'
    infile2 = 'laso_genotype.txt'
    format_name1 = 'guoke'
    format_name2 = 'lasuo'
    print(which_format(infile1,format_name1))
    print(which_format(infile2,format_name2))

def test_config():             
    config = 'project_type_need_rs.txt'
    item = get_need_rs(config)
    print(item )

def test_get_rs_from_genotype():             
    infile = 'laso_genotype.txt'
    sample_name = 'R190064'
    rs_dict = get_want_rs(infile,sample_name,'lasuo') 
    i = 0
...
def test_write_rs():
    snp_outfile='outfile'
    infile = '20191209_2s_Finalreport.txt'
    sample_name = 'R190854'
    rs_dict = get_want_rs(infile,sample_name,'lasuo') 
    config = 'project_type_need_rs.txt'
    item = get_need_rs(config)
    ...
    write_rs(snp_outfile,rs_dict,want_rs,miss_out_file)
#@pysnooper.snoop()
def main():
    ...
    want_product_english = config['product'][args.project]
#    print(project)
    print('------want_rs===')
